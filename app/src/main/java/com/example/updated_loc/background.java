...
class background extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // latitudeTextView = findViewById(R.id.latTextView);
        ...
        //  @SuppressLint("ResourceType") RelativeLayout bck_img = findViewById(R.drawable.background);
    ...
    /**
     * public void Image_time() {
     * <p>
     * Calendar c = Calendar.getInstance();
     * int timeOfDay = c.get(Calendar.HOUR_OF_DAY);
     * ConstraintLayout homeLayout = findViewById(R.id.background);
     * <p>
     * if(timeOfDay >= 7 && timeOfDay < 18){
     * homeLayout.setBackgroundResource(R.drawable.day_image);
     * }
     * else {
     * homeLayout.setBackgroundResource(R.drawable.night_image);
     * }
     * }
     **/
